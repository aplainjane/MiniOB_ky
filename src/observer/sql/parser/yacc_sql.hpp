...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    GE = 319,                      /* GE  */
    NE = 320,                      /* NE  */
    I2_DISTANCE_T = 321,           /* I2_DISTANCE_T  */
    COSINE_DISTANCE_T = 322,       /* COSINE_DISTANCE_T  */
    INNER_PRODUCT_T = 323,         /* INNER_PRODUCT_T  */
    SUM = 324,                     /* SUM  */
    AVG = 325,                     /* AVG  */
    COUNT = 326,                   /* COUNT  */
    MAX = 327,                     /* MAX  */
    ...
    ID = 331,                      /* ID  */
    SSS = 332,                     /* SSS  */
    SUB_QUERY = 333,               /* SUB_QUERY  */
    VECTOR_LIST = 334,             /* VECTOR_LIST  */
    UMINUS = 335                   /* UMINUS  */
  };
