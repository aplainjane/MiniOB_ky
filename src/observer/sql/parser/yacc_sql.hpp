...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    GE = 316,                      /* GE  */
    NE = 317,                      /* NE  */
    I2_DISTANCE_T = 318,           /* I2_DISTANCE_T  */
    COSINE_DISTANCE_T = 319,       /* COSINE_DISTANCE_T  */
    INNER_PRODUCT_T = 320,         /* INNER_PRODUCT_T  */
    SUM = 321,                     /* SUM  */
    AVG = 322,                     /* AVG  */
    COUNT = 323,                   /* COUNT  */
    MAX = 324,                     /* MAX  */
    ...
    ID = 328,                      /* ID  */
    SSS = 329,                     /* SSS  */
    SUB_QUERY = 330,               /* SUB_QUERY  */
    VECTOR_LIST = 331,             /* VECTOR_LIST  */
    UMINUS = 332                   /* UMINUS  */
  };
